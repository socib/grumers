...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JellyfishSpecie.order'
        db.add_column(u'data_jellyfishspecie', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JellyfishSpecie.order'
        db.delete_column(u'data_jellyfishspecie', 'order')
