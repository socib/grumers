...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JellyfishSpecie.common_name'
        db.alter_column(u'data_jellyfishspecie', 'common_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'JellyfishSpecie.common_name'
        db.alter_column(u'data_jellyfishspecie', 'common_name', self.gf('django.db.models.fields.CharField')(default='-', max_length=100))
