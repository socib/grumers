...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservationRoute.code'
        db.add_column(u'data_observationroute', 'code',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservationRoute.code'
        db.delete_column(u'data_observationroute', 'code')
