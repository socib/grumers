...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JellyfishSpecie.picture'
        db.add_column(u'data_jellyfishspecie', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(default='jellyfish_species/no-img.jpg', max_length=100),
                      keep_default=False)

        # Adding field 'JellyfishObservation.picture'
        db.add_column(u'data_jellyfishobservation', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JellyfishSpecie.picture'
        db.delete_column(u'data_jellyfishspecie', 'picture')

        # Deleting field 'JellyfishObservation.picture'
        db.delete_column(u'data_jellyfishobservation', 'picture')
