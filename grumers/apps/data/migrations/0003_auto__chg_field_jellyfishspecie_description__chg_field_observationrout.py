...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JellyfishSpecie.description'
        db.alter_column(u'data_jellyfishspecie', 'description', self.gf('django.db.models.fields.TextField')(null=True))
        # Adding M2M table for field groups on 'ObservationRoute'
        m2m_table_name = db.shorten_name(u'data_observationroute_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('observationroute', models.ForeignKey(orm[u'data.observationroute'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['observationroute_id', 'group_id'])


        # Changing field 'ObservationRoute.description'
        db.alter_column(u'data_observationroute', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'JellyfishSpecie.description'
        db.alter_column(u'data_jellyfishspecie', 'description', self.gf('django.db.models.fields.TextField')(default=' '))
        # Removing M2M table for field groups on 'ObservationRoute'
        db.delete_table(db.shorten_name(u'data_observationroute_groups'))


        # Changing field 'ObservationRoute.description'
        db.alter_column(u'data_observationroute', 'description', self.gf('django.db.models.fields.TextField')(default=' '))
