...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ObservationRoute.route_type'
        db.add_column(u'data_observationroute', 'route_type',
                      self.gf('django.db.models.fields.CharField')(default='C', max_length=1),
                      keep_default=False)

        # Adding field 'ObservationRoute.island'
        db.add_column(u'data_observationroute', 'island',
                      self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservationRoute.municipality'
        db.add_column(u'data_observationroute', 'municipality',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ObservationStation.station_type'
        db.add_column(u'data_observationstation', 'station_type',
                      self.gf('django.db.models.fields.CharField')(default='S', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ObservationRoute.route_type'
        db.delete_column(u'data_observationroute', 'route_type')

        # Deleting field 'ObservationRoute.island'
        db.delete_column(u'data_observationroute', 'island')

        # Deleting field 'ObservationRoute.municipality'
        db.delete_column(u'data_observationroute', 'municipality')

        # Deleting field 'ObservationStation.station_type'
        db.delete_column(u'data_observationstation', 'station_type')
