...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JellyfishObservation.sting_incidents'
        db.add_column(u'data_jellyfishobservation', 'sting_incidents',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'JellyfishObservation.total_incidents'
        db.add_column(u'data_jellyfishobservation', 'total_incidents',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JellyfishObservation.sting_incidents'
        db.delete_column(u'data_jellyfishobservation', 'sting_incidents')

        # Deleting field 'JellyfishObservation.total_incidents'
        db.delete_column(u'data_jellyfishobservation', 'total_incidents')
