...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'FlagChange'
        db.delete_table(u'data_flagchange')

        # Deleting field 'ObservationRoute.use_incident_form'
        db.delete_column(u'data_observationroute', 'use_incident_form')
    ...
    models = {
        ...
        u'data.jellyfishincident': {
            'Meta': {'ordering': "['-date_observed']", 'object_name': 'JellyfishIncident'},
